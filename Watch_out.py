...
'''app = QApplication([])
main_win = QWidget()
main_win.setWindowTitle('Главный экран')
btn_OK = QPushButton('Играть')'''
font.init()
...
win_width = 700
win_height = 500
display.set_caption('Watch out!')
window = display.set_mode((win_width,win_height))
background = transform.scale(image.load(img_back),(win_width,win_height))
ship = Player(img_hero, 5, win_height-200, 160, 200, 10)
...
window = QWidget()
window.setLayout(layout_line3)
window.setWindowTitle('Watch out!')
